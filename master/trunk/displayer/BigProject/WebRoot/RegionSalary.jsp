...
$(function () {
        ...
        var money = new Array();//各城市工资的数组
        $.ajax({
                type:"POST",
                url:"action/RegionSalaryAction.action",
                dataType:'json',
                async:false,
        ...
        $('.maincontentinner').highcharts({
            ...
            tooltip: {
                ...
                pointFormat: '<tr><td style="color:{series.color};padding:0;font-size:5px;min-width:30px;">{series.name}: </td>' +
                    '<td style="padding:0;font-size:5px;min-width:70px;"><b>{point.y:.1f} 元</b></td></tr>',
                footerFormat: '</table>',
                shared: true,
                useHTML: true
            },
    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                <li class="active"><a href="RegionSalary.jsp" style="letter-spacing:3px;font-size:16px;color:white;"><span class="iconfa-signal"></span> <font face="微软雅黑">地区工资分布图</font></a></li>
